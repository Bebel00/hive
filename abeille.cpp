...
Abeille::Abeille(class Joueur* joueur) : Insecte(joueur)
{
...
bool Abeille::enregistre = UsineInsecte::get_usine().enregistrer_type(Type::Type::ABEILLE, [](Joueur* joueur) {
    return std::make_unique<Abeille>(joueur);
});
